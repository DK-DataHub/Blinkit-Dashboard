...
Identify high- and low-performing outlets using performance segmentation
...
Button slicer with four metrics:
Total Sales
Average Sales
Average Rating
Number of Items
Metric selection dynamically updates:
KPI cards
Line chart trends
...
(Respond dynamically to slicer selection)

✅ Line Chart

Metric trends by Outlet Establishment Year
Helps identify growth patterns across years

✅ Funnel Chart

Total Sales by Item Type
Shows contribution of different product categories
Highlights top-selling and low-performing item types

✅ Stacked Column Chart

Sales Category vs Outlet Establishment Year
Outlets segmented into:
High
Low
